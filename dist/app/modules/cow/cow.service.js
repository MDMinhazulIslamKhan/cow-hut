...
const createCow = cow =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createdCow = (yield cow_model_1.default.create(cow)).populate(
      'sellerId'
    );
    if (!createdCow) {
...
const getAllCows = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm, minPrice = 0, maxPrice = Infinity } = filters,
...
const updateCow = (id, payload, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    if (payload.sellerId) {
      throw new ApiError_1.default(
        http_status_1.default.CONFLICT,
        "Can't change sellerId!!!"
      );
    }
    ...
    if (
      ...
      ((_a = cow === null || cow === void 0 ? void 0 : cow.sellerId) === null ||
      _a === void 0
        ? void 0
        : _a.phoneNumber)
    ) {
...
const deleteCow = (id, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      userInfo.phoneNumber !==
      ((_b = cow === null || cow === void 0 ? void 0 : cow.sellerId) === null ||
      _b === void 0
        ? void 0
        : _b.phoneNumber)
    ) {
