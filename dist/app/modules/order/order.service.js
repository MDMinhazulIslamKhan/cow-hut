...
const createOrder = (token, password, cow) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userInfo = yield jsonwebtoken_1.default.verify(
      token,
      config_1.default.jwt.secret
    );
    const existingUser = yield user_model_1.default.isUserExist(
    ...
    const isPasswordMatch = yield user_model_1.default.isPasswordMatch(
      password,
    ...
    if (
      (user === null || user === void 0 ? void 0 : user.budget) &&
      existingCow.price >=
        (user === null || user === void 0 ? void 0 : user.budget)
    ) {
      throw new ApiError_1.default(
    ...
    try {
      ...
      yield cow_model_1.default.findOneAndUpdate(
        { _id: cow },
        { label: 'sold out' },
        {
          session,
      ...
      createdOrder = yield order_model_1.default.create(
        [{ cow, buyer: existingUser.id }],
        {
          session,
        }
      );
    ...
    const order = order_model_1.default
      .findById(createdOrder[0].id)
      .populate({
        path: 'cow',
        model: 'Cow',
      })
...
const getSingleOrder = (id, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const user = yield jsonwebtoken_1.default.verify(
      token,
      config_1.default.jwt.secret
    );
    ...
    const orderResult = yield order_model_1.default
      .findById(id)
      .populate(['cow', 'buyer']);
    if (!orderResult) {
      throw new ApiError_1.default(
    ...
    if (
      (userInfo === null || userInfo === void 0 ? void 0 : userInfo.role) !==
        'admin' &&
      (userInfo === null || userInfo === void 0 ? void 0 : userInfo.id) !==
        (orderResult === null || orderResult === void 0
          ? void 0
          : orderResult.buyer.id.toString()) &&
      (userInfo === null || userInfo === void 0 ? void 0 : userInfo.id) !==
        (cow === null || cow === void 0 ? void 0 : cow.sellerId.toString())
    ) {
      throw new ApiError_1.default(
        http_status_1.default.UNAUTHORIZED,
        'Unauthorized!!!'
