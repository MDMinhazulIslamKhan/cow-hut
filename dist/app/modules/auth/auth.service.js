...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelpers_1.jwtHelpers.createToken({ phoneNumber: userPhoneNumber, role }, config_1.default.jwt.secret, config_1.default.jwt.expire_in);
    const refreshToken = jwtHelpers_1.jwtHelpers.createToken({ phoneNumber: userPhoneNumber, role }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expire_in);
    return {
        accessToken,
        refreshToken,
    };
...
const refreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExist = yield user_model_1.default.isUserExist(verifiedToken.phoneNumber);
    if (!isUserExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "User doesn't exist!!!");
    }
